...
describe('offset()', function() {
	...
	it('should override the default offsetVal value when a offset is provided', function() {
		qb.resetQuery();
		qb.offset(10);
		qb.offsetVal.should.eql(10);
	});
